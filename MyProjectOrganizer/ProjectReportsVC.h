...
@interface ProjectReportsVC : HomeVC <UINavigationControllerDelegate, UIImagePickerControllerDelegate, UIPopoverControllerDelegate, UICollectionViewDataSource, UICollectionViewDelegate, PictureDelegate, PropertyDelegate, PropertyCellDelegate>
...
@property (weak, nonatomic) IBOutlet UICollectionView *colReports;
